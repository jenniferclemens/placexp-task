...
<div style="background-color:#FFFFFC; width:50%; text-align:left; padding:50px; margin:0 auto;">
		...
		<center><h2 style="font-family:'Times New Roman'; color:black; ">Sign into Notes</h2></center>
		</div>
		<br>
		<form action="signin.php" name="form" id="userfrm" method="post">
		<fieldset>
		<legend style="background-color:#36BABF">Enter the following</legend>
			...
			<input name="password" type="password" minlength="8" maxlength="12"required /> <br><br>
		
		</fieldset>
		<center><br>
			<a href="notes.php"><input style="border: none;background-color: #E25068; color: white; padding: 15px 32px; text-align: center;display: inline-block; font-size: 16px;" type="button" onclick="validpw(document.form1)" name="submit-btn" value="Submit Form"/></a><br><br>
